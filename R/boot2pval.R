...
#' @param iter The number of iterations for interval generation
#' @param mudiff The null value for the difference of sample means
#' @param test A value that moderates what is generated
#'
#' @return The p-value and a graph depicting the confidence interval
#' @export
#'
#' @examples
