#' myboot2
#'
#' @param iter The amount of samples generated.
#' @param x A given sample.
#' @param fun The function that will be tested.
#' @param alpha The alhpa value for the confidence interval.
#' @param ... Any extra modifications that will be made to the histogram generated.
#'
#' @return A list of multiple values calculated.
#' @export
#' @examples
